...
```bash
git clone https://github.com/furdomainplot/MTFLASH_UBL_SNAPDRAGON-735.git
cd MTFLASH_UBL_SNAPDRAGON-735
python setup.py
```
...
<p align="center">
  <a href=" alt="Version" src="https://img.shields.io/badge/version-v1.5-111111?style=for-the-badge"></a>
...
<!-- Last updated: 2026-06-05 15:12:11 -->
